...
## Wrapping up
<Picture src={perfectScore} alt='resulting scores' widths={[200, 400, 800]} sizes="(max-width: 800px) 100vw, 800px" formats={['avif', 'jpeg', 'png', 'webp']} />
The experience of optimizing this blog was fun, going to the basics I got to tweak a lot of low level aspects.  

Using Astro I was able to build something I really like (especially from an architectural point of view),   
